...
var git = ''
var verified = ''
if (Config.LANG == 'EN') name = 'Name', title = 'Info Bot', version = 'Version', aut/dev = 'Author & Developer', branch = 'Branch', verified = 'Official', FU = 'False ( Unofficial )', TO = 'True ( Official )', git = 'Git'
if (Config.LANG == 'ML') name = 'പേര്', title = 'ബോട്ട് വിവരങ്ങൾ', version = 'പതിപ്പ്', aut/dev = 'രചയിതാവ് & ഡെവലപ്പർ', branch = 'ബ്രാഞ്ച്', verified = 'ഔദ്യോടികം', FU = 'തെറ്റായത് ( അനൗദ്യോഗിക )', TO = 'ശരിയായത് ( ഔദ്യോദ്യഗം )', git = 'ഗിറ്റ്'
if (Config.LANG == 'ID') name = 'Nama', title = 'Bot Informasi', version = 'Versi', aut/dev = 'Penulis & Pengembang', branch = 'cabang', verified = 'resmi', FU = 'Salah ( Tidak Resmi )', TO = 'Benar ( Resmi )', git = 'Git'

    var official = ''
    if (Config.GIT.includes('TOXIC-DEVIL/WhatsAlexa')) { official = '*✅️ '+verified+':* ```'+TU+'```'
    } else { official = '*❗️'+verified+':* ```'+FU+'```'

    let InFoCaPtIoN = '『 '+title+' 』\n\n*📝 '+name+':* ```WhatsAlexa```\n*💬 '+version+':* ```'+Config.VERSION+'```\n*💫 '+branch+':* ```'+Config.BRANCH+'```\n*👨‍💻 '+aut/dev+':* ```'+Config.DEVELOPER+'```\n'+official+'\n*🌐 '+git+':* ```'+Config.GIT+'```'
